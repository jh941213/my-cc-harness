...
description: >
  Python asyncio and async/await patterns guide. Use when building async APIs, concurrency systems, or I/O-bound applications.
  Triggers: "asyncio", "async/await", "async Python", "concurrent", "aiohttp", "async patterns"
  Anti-triggers: "synchronous Python", "JavaScript async", "Go goroutine", "multiprocessing only"
